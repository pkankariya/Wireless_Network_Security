...
# Files of csv format filtered based on the data
...
# Label encoding of data as required
...
# Creation of neural network model to process the incoming request and identifying if it is genuine or a malicious threat
# Define model to be used
model = Sequential()
# Input layer
model.add(Dense(8, input_dim=8, init='normal', activation='tanh'))
...
# Graphical repersentation of the results
